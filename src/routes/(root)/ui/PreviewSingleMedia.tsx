        ...
        <div className="flex justify-center my-4">
          ...
          >
            <div className="flex justify-center items-center">
              <span className="block mr-2 text-sm">{t("preview.compare")}</span>
              <Icon name="compare" />
            </div>
          </Switch>
        </div>
      ...
      {!(isMediaTransformEditMode || isMediaTrimEditMode) ? (
        isProcessCompleted ? (
          <section className="animate-appearance-in">
            ...
            {!(compressedSizeDiff <= 0) ? (
              <p className="block text-5xl text-center text-green-500">
                ...
                %<span className="text-large block">{t("preview.smaller")}</span>
              </p>
            ) : null}
          </section>
        ) : (
          <section className={cn(['my-4 mb-2', styles.videoMetadata])}>
            <>
              <div>
                <p className=" text-gray-600 dark:text-gray-400">{t("preview.size")}</p>
            ...
            <>
              <div>
                <p className=" text-gray-600 dark:text-gray-400">{t("preview.extension")}</p>
            ...
            {videoDuration ? (
              <>
                <div>
                  <p className=" text-gray-600 dark:text-gray-400">{t("preview.duration")}</p>
                  <span className="block font-black">
            ...
            <>
              {fps ? (
                <>
                  <div>
                    <p className=" text-gray-600 dark:text-gray-400">{t("preview.fps")}</p>
